...
@hydra.main(config_path="../../configs_local/eval/sampling", config_name="redesign_seq", version_base="1.3.2")
def main(cfg: DictConfig):
    ...
    if cfg.redesign_cfg.get("redesign_seq", False):
        ...
        # Add designed_sample_id and designed_sample_atom_array keys for consistency
        for sample_id in sample_dict.keys():
            sample_dict[sample_id]["designed_sample_id"] = [sample_id]
            sample_dict[sample_id]["designed_sample_atom_array"] = [sample_dict[sample_id]["sample_atom_array_with_ligand"]]
            sample_dict[sample_id]["designed_sample_path"] = [sample_dict[sample_id].get("input_sample_path", "")]
            sample_dict[sample_id]["designed_sample_path_for_af3_tc"] = [sample_dict[sample_id].get("input_sample_path", "")]
