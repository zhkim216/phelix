...
from allatom_design.eval.eval_utils.bb_gen_utils import (
    get_bb_gen_model, run_bb_scaffold_sampling)
...
def main(cfg: DictConfig):
    ...
    ### Load in PDB files to extract motifs from ###
    pdb_files = get_pdb_files(**cfg.input_cfg)

    ### Run scaffold sampling ###
    sampled_pdb_paths = run_bb_scaffold_sampling(bb_gen_model["model"], bb_gen_model["scaffold_manager"], bb_gen_model["sampling_cfg"],
                                                 pdb_files, device, log_dir)
