...
@hydra.main(config_path="../configs_local/eval", config_name="eval_caliby_lmpnnval_af3", version_base="1.3.2")
def main(cfg: DictConfig):
    ...
    for sample_id in tqdm(sample_ids, desc="Extracting ligands"):
        ...
        sample_dict[sample_id]["original_ligand_atom_array"] = None  # Initialize as None        
        ...
        ligand_array = extract_ligand_from_structure(orig_array, ligand_pn_unit_iids=ligand_pn_unit_iid_list)
        sample_dict[sample_id]["original_ligand_atom_array"] = ligand_array
    ...
    for sample_id in tqdm(sample_ids, desc="Loading structures"):
        ...
        prot_bb_atom_array = sample_atom_array[sample_atom_array.chain_type == aw_enums.ChainType.POLYPEPTIDE_L]
