...
def main(cfg: DictConfig):
    ...
    af3_monomer_manifest = af3_monomer_manifest[["pdb_name", "cluster_id", "phase"]].rename(columns={"pdb_name": "input_pdb_name"})
    ...
    if len(unannotated_rows) > 0:
        ...
        print(unannotated_rows[["input_pdb_name", "pdb_name", "phase"]])
