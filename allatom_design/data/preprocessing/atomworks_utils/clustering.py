"""
Adapted from AtomWorks
https://github.com/RosettaCommons/atomworks/blob/3af22940a907a1c88778cdf99860920e8c8e6212/src/atomworks/ml/preprocessing/utils/clustering.py

Changed to only cluster protein sequences, and to assign short sequences, nucleotides, and non-polymer sequences each to their own cluster.
"""
...
def cluster_all_sequences(
    ...
    Args:
        ...
        temp_dir (str | None): Path to the temporary directory to store the FASTA file and clustering results. If None, a temporary directory is created in the current working directory.
