...
class MPNNDiTDenoiser(BaseAtomDenoiser):
    def __init__(self,
        ...
        """
        Backbone diffusion with DiT using MPNN encoder.
        """
        super().__init__()
        ...
        # Set up DiT
        self.dit = MPNNDiT(cfg.dit, self.interpolant)
        ...
        if self.use_autoguidance:
            ...
            self.guiding_model = MPNNDiT(OmegaConf.merge(cfg.dit, cfg.autoguidance.dit), self.interpolant)  # override with autoguidance config
