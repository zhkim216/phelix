    ...
    with initialize_config_dir(config_dir=config_dir, version_base="1.3.2"):
        cfg = compose(
            ...
            overrides=[
                ...
                "data.sampling_weights.alphas_interface.alpha_protein_metal=0.0",
