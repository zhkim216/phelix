...
from openfold.utils.tensor_utils import (masked_mean, permute_final_dims,
...
def backbone_loss(
    backbone_rigid_tensor: TensorType["b n 4 4", float],
    backbone_rigid_mask: TensorType["b n", float],
    traj: TensorType["l b n 7", float],
...
def sidechain_loss(
    sidechain_frames: TensorType["l b n f 4 4", float],
    sidechain_atom_pos: TensorType["l b n a 3", float],
    rigidgroups_gt_frames: TensorType["b n f 4 4", float],
    rigidgroups_alt_gt_frames: TensorType["b n f 4 4", float],
    rigidgroups_gt_exists: TensorType["b n f", float],
    renamed_atom14_gt_positions: TensorType["b n 14 3", float],
    renamed_atom14_gt_exists: TensorType["b n 14", float],
    alt_naming_is_better: TensorType["b n", float],
    clamp_distance: float = 10.0,
