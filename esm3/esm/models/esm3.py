...
from esm3.esm.models.vqvae import (
...
from esm3.esm.utils.constants.models import (
    ESM3_OPEN_SMALL,
    normalize_model_name,
)
from esm3.esm.utils.decoding import decode_protein_tensor
from esm3.esm.utils.generation import (
    _batch_forward,
    _sample_per_prompt,
...
from esm3.esm.utils.misc import rbf
from esm3.esm.utils.sampling import (
    _BatchedESMProteinTensor,
    get_default_sampling_config,
    validate_sampling_config,
)
from esm3.esm.utils.structure.affine3d import (
...
class ESM3(nn.Module, ESM3InferenceClient):
    ...
    def from_pretrained(
        ...
        from esm3.esm.pretrained import load_local_model
