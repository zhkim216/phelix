"""Smoke tests for the Sherlock Elix environment installation.
...
Set ELIX_INSTALL_TEST_STRICT=1 after installing the Sherlock environment to
...
STRICT = os.environ.get("ELIX_INSTALL_TEST_STRICT") == "1"
REQUIRE_GPU = os.environ.get("ELIX_REQUIRE_GPU") == "1"
